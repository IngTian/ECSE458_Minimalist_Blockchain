...
#define NUMBER_OF_TEST_MODEL 5
#define TEST_TRANSACTION_TYPE 2
#define NUMBER_OF_TEST_TRANSACTION_INPUT 4
#define NUMBER_OF_TEST_TRANSACTION_OUTPUT 4
...
#define PERSISTENCE_ENGINE PERSISTENCE_ENGINE_MEMORY
